...
These are defined in the ambient Euclidean spaces: the target functions we optimize are the restrictions of the functions onto the manifold of interest.
\Cref{fig:benchmark-functions} plots these benchmark functions for a Euclidean space of dimension two.
