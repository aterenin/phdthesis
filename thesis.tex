...
The precise consequences of such developments are uncertain, and will also likely include negative impacts.
At present, however, it is clear that visions such as the one presented here are purely hypothetical.
Humanity has a ways to go before our understanding of machine learning and artificial intelligence reaches a sufficient degree of command to build such systems.
...
Then the map $b_*\P : \c{B} \x A \-> [0,1]$ is a regular conditional probability measure.
\end{lemma}

\begin{proof}
Is this actually true? How do we show it's $a$-measurable?
\end{proof}
