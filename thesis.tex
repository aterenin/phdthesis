...
$(\Omega,\c{F},\P)$ & probability space & \labelcpageref{ntn:prob-space} \\
$\E(\.)$ & expectation of a real-or-vector-valued random variable & \labelcpageref{ntn:expectation} \\
$\Cov$ & covariance of real-or-vector-valued random variables & \labelcpageref{ntn:cov} \\
$y \~ \pi$ & $\pi$-distributed random variable $y$ & \labelcpageref{ntn:distr} \\
$D_{\f{KL}}(\.||\.)$ & Kullback--Leibler divergence of probability measures & \labelcpageref{ntn:kl-div} \\
$W_{p,d}(\.,\.)$ & Wasserstein distance of $p$th order over metric $d$ & \labelcpageref{ntn:wass-dist} \\
...
\begin{xltabular}{\textwidth}{p{1.5cm} X >{\raggedleft\arraybackslash}p{0.625cm}}
$(\Theta,\mathit\Theta)$ & measurable space representing quantity of interest & \labelcpageref{ntn:meas-space} \\ 
$(Y,\c{Y})$ & measurable space representing the data & \labelcpageref{ntn:meas-space} \\
$A_{(\.)}$ & measurable set & \labelcpageref{ntn:meas-space} \\
$\theta, y$ & random variables & \labelcpageref{ntn:rv} \\ 
$\pi_{(\.)}$ & probability measure & \labelcpageref{ntn:prob-meas} \\ 
