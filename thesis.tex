...
Let $(X,g)$ be an Riemannian manifold, assumed oriented without loss of generality.
...
In particular, if $X$ is Riemannian with metric $g$, we have $\m{P}_F^T \m{P}_F = \m\Gamma$, where $\Gamma_{ij} = g(e_i(x), e_j(x))$, giving the coordinate representation of the identity map with respect to the metric.
