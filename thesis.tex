...
From \Cref{thm:mvn-pw}, we obtain a second method for sampling multivariate Gaussians: (i) sample $\v\theta,\v{y}$ jointly, and (ii) transform $\v\theta,\v{y}$ into $\v\theta\given\v{y}=\v\gamma$ by employing the given expression.
