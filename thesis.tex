...
In order to pursue these questions, we begin by introducing and reviewing the settong of Riemannian geometry.

\subsection{Review of Riemannian geometry}
We now briefly review the notions needed to define and understand Riemannian manifolds.
...
A smooth manifold is called \emph{oriented} if the Jacobian determinant of all chart transition maps is positive.
...
The metric tensor can be thought of as an algebraic object encoding the manifold's quantitative shape, and give rise to notions such as \emph{geodesics}, \emphmarginnote{volume}, \emph{integration}.
Volume is a $d$-form, which we recall is a $(0,d)$-tensor field, and induces a measure on the manifold---we denote both by $\vol_g$.
...
\begin{definition}[Laplce--Beltrami operator]
