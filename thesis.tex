...
$\Cov(\.,\.)$ & covariance between a pair of real-valued random variables & \labelcpageref{ntn:expectation-cov} \\
...
$V^*$ & dual space of a topological vector space $V$ & \labelcpageref{ntn:dual-space-ops} \\
...
$L(V;W)$ & Banach space of bounded linear operators & \labelcpageref{ntn:dual-space-ops} \\
