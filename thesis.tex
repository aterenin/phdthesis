...
$\oplus$ & Direct sum of a vector space & \labelcpageref{ntn:direct-sum} \\
...
$C^\infty(X)$ & Space of smooth real-valued functions over $X$ & \labelcpageref{ntn:smooth-fns} \\
...
To ease notation, we often omit real ranges from function spaces written in the sequel.
...
From a theoretical point of view, one of the first steps to be taken in understanding Bayesian algorithm execution is to understand what is the appropriate notion of \emph{regret} for this setting, among a number of possible variations, and developing techniques for studying it.
