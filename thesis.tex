...
Note that in this definition, the statement $\f{ev}_x \in \c{H}^*$ means that $\f{ev}_x$ is a bounded linear functional.
...
It is easy to see that $k_{\c{H}}$ is positive semi-definite.
