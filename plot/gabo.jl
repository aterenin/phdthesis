        ...
        merge(
            {
                ...
                legend_columns = 2, 
                legend_style = raw"draw={none}, fill={none}, at={(0.5,1.2)}, anchor={south}, font={\footnotesize}, column sep={0.0625cm}, /tikz/every even column/.append style={column sep={0.375cm}}",
