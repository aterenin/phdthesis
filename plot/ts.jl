...
@pgf GroupPlot(
    ...
    [Axis(
        merge(
            ...
            l == 4096 ? PGFPlotsX.Options("axis y line*={right}" => nothing) : PGFPlotsX.Options("axis y line*={left}" => nothing),
            l == 4096 ? PGFPlotsX.Options(:ylabel_style => "rotate=180, yshift={-0.875cm}") : PGFPlotsX.Options(),
